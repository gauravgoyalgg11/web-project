...
<head>
    ...
    <script type='text/javascript'>
        function doSel(ctrlSug) {
            var pos = ctrlSug.selectedIndex;
            if (pos == 0) {
                document.getElementById('tbl').style.display = 'contents';
                document.getElementById('tbl1').style.display = 'none';
                document.getElementById('tbl2').style.display = 'none';
            }
            if (pos == 1) {
                document.getElementById('tbl1').style.display = 'contents';
                document.getElementById('tbl').style.display = 'none';
                document.getElementById('tbl2').style.display = 'none';
            }
            if (pos == 2) {
                document.getElementById('tbl2').style.display = 'contents';
                document.getElementById('tbl').style.display = 'none';
                document.getElementById('tbl1').style.display = 'none';
            }
    ...
    <script>
        ...
        $module.controller("mycontroller", function($scope, $http) {
            ...
            $scope.doFetch = function() {
                ...
                $http.get('history-sugar-fetchall.php?uid=' + id + "&df=" + df + "&dt=" + dt).then(ok, notok);
    ...
    <div class='container'>
        <div class='form-group'>
            <div class='row'>
                <div class='col-md-12'>
                    ...
                    <input type='text' id='txtUid' class='form-control' placeholder="Enter Your Id" name='txtUid' ng-model='uid' ng-init="uid='<?php echo $_SESSION["activeuser"]; ?>' " value='<?php echo $_SESSION["activeuser"]; ?>' readonly>
                    <span id='errUid'></span>
                </div>
            </div>
        </div>
        <div class='form-group'>
            <div class='row'>
                ...
                <div class='col-md-4'>
                    <label for='sugTyp'>
                        <h2><small>Sugar Type</small></h2>
                    </label>
                    <select class="custom-select" id='sugTyp' onchange='doSel(this);'>
            ...
            <div class='row mt-4'>
                <div class='col-md-4 offset-md-4'>
                    <div class='btn btn-primary form-control mt-1' ng-click='doFetch();' id='FetchsugHis' name='FetchsugHis'>Fetch Record</div>
                </div>
            </div>
        </div>
        <div class=''>
            <table class="table" id='tbl'>
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th scope="col">Sugar Checked Time</th>
                        <!--                        <th scope="col">Age</th>-->
            ...
            <table class="table" id='tbl1'>
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th scope="col">Sugar Checked Time</th>
                        <!--                        <th scope="col">Age</th>-->
                        <th scope="col">Medicine Intake</th>
                        <th scope="col">Result</th>
                    </tr>
                </thead>
                <tbody>
            ...
            <table class="table" id='tbl2'>
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th scope="col">Sugar Checked Time</th>
                        <!--                        <th scope="col">Age</th>-->
                        <th scope="col">Blood Sugar Result</th>
                        <th scope="col">Medicine Intake</th>
                        <th scope="col">Urine Sugar Result</th>
                    </tr>
                </thead>
                <tbody>
                    <tr ng-repeat='obj in jsonAry | orderBy:cname | filter:googler'>
